...
⚠️ **Attention**, depuis la version 2.15 de GeoNature, ce module a été intégré dans le coeur de GeoNature et n'est plus à installer et mettre à jour indépendamment. Ce dépôt va donc être archivé prochainement.
