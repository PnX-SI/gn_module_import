...
CREATE TABLE dict_fields(
    ...
    order_synthese integer NOT NULL
);
...
ALTER TABLE ONLY cor_synthese_nomenclature
    ADD CONSTRAINT fk_cor_synthese_nomenclature_id_field FOREIGN KEY (id_field) REFERENCES gn_imports.dict_fields(id_field) ON UPDATE CASCADE ON DELETE CASCADE;
...
INSERT INTO dict_fields (id_field, name_field, fr_label, eng_label, desc_field, type_field, synthese_field, mandatory, autogenerated, nomenclature, id_theme, order_field, order_synthese) VALUES
    ...
    (45, 'id_nomenclature_geo_object_nature', 'Nature d''objet géographique', '', '', 'integer', TRUE, FALSE, FALSE, TRUE, 2, 12),
    (46, 'id_nomenclature_obs_technique', 'Techniques d''observation', '', '', 'integer', TRUE, FALSE, FALSE, TRUE, 3, 11),
    (47, 'id_nomenclature_observation_status', 'Statut d''observation', '', '', 'integer', TRUE, FALSE, FALSE, TRUE, 3, 12),
    (48, 'id_nomenclature_source_status', 'Statut de la source', '', '', 'integer', TRUE, FALSE, FALSE, TRUE, 3, 13);
