...
def check_entity_source(
    df, added_cols, selected_columns, synthese_fields, import_id, schema_name
):
    try:
        fields = [field.name_field for field in synthese_fields]
...
def check_id_digitizer(df, selected_columns, synthese_fields, import_id, schema_name):
    try:
