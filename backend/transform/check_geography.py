...
def check_geography(df, import_id, added_cols, selected_columns, dc_user_errors, srid, local_srid):
    ...
    try:
        ...
        # set column names :
        create_col_name(col_dict=selected_columns, key='the_geom_4326', value='the_geom_4326', import_id=import_id)
        create_col_name(col_dict=selected_columns, key='the_geom_point', value='the_geom_point', import_id=import_id)
        create_col_name(col_dict=selected_columns, key='the_geom_local', value='the_geom_local', import_id=import_id)
